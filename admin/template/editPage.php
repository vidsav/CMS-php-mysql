<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            <h3>Edit page</h3><hr>
            <form method="post" action="?action=updatePage">
                ...
                <div class="control-group">
                    ...
                    <div class="form-group col-xs-9 controls">
                        <select name="is_active" class="form-control">
                            <option value="1" <?php $page['is_active'] ? echo('selected') : '' ?>>Yes</option>
                            <option value="0" <?php !page['is_active'] ? echo('selected') : '' ?>>No</option>
                        </select>
